...
export const DancingLetters = ({
  ...
  const triggerLetterAnimation = useCallback((index) => {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        {letters.map((letter, id) => {
          ...
          return (
            <m.span
              ...
              className={cn(
                "relative inline-block cursor-pointer transition-colors duration-150 hover:text-cyan-300",
                letterClassName,
                isActive ? "z-10 text-cyan-300" : "z-0"
              )}
              style={{
        ...
        {showAsterisk && (
          <span className="relative top-[-0.35em] text-[0.35em] text-cyan-400 font-bold ml-0.5 select-none pointer-events-none">
            *
          </span>
        )}
      </m.div>
